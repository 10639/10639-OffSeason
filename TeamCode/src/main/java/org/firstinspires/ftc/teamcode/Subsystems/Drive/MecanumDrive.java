...
public final class MecanumDrive {
    ...
    public static class Params {
        ...
        public double lateralInPerTick = 0.0004424836283868032;
        public double trackWidthTicks = 28139.715628318394;

        // feedforward parameters (in tick units)
        public double kS = 1.26;
        public double kV = 0.000062;
        public double kA = 0.00022;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "lrdrive");
        rightBack = hardwareMap.get(DcMotorEx.class, "rrdrive");
        ...
        localizer = new ThreeDeadWheelLocalizer(hardwareMap, PARAMS.inPerTick); //Our Localization Method
